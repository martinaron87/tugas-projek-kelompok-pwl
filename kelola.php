...
<body class="pt-5">
    ...
    <?php elseif (isset($_GET['tambah']) && $_GET['tambah'] == 'servis') : ?>
        <div class="container">
            ...
            <figure class="text-center">
                <blockquote class="blockquote">
                    <p>Berisi data jenis dan biaya jasa service yang tersedia di toko Service Gadget</p>
                </blockquote>
                <figcaption class="blockquote-footer">
                    CRUD - <cite title="Source Title">Create, Read, Update, Delete</cite>
                </figcaption>
        ...
        <div class="container">
            ...
            <figure class="text-center">
                <blockquote class="blockquote">
                    <p>Berisi data harga sparepart yang tersedia di toko Service Gadget</p>
                </blockquote>
                <figcaption class="blockquote-footer">
                    CRUD - <cite title="Source Title">Create, Read, Update, Delete</cite>
                </figcaption>
